...
par(mfrow = c(2, 2))
hist(pred.pcr)
plot(y.test, pred.pcr, alpha = 0.1)
...
par(mfrow = c(2, 2))
hist(pred.pls)
plot(y.test, pred.pls, alpha = 0.1)
...
par(mfrow = c(2, 2))
hist(pred.knn)
plot(y.test, pred.knn, alpha = 0.1)
...
par(mfrow = c(2, 2))
hist(pred.cart)
plot(y.test, pred.cart, alpha = 0.1)
...
par(mfrow = c(2, 2))
hist(pred.gbm)
plot(y.test, pred.gbm, alpha = 0.1)
